...
class TDSBomLine(models.Model):
    ...
    tds_cost = fields.Float('Cost', related='product_id.standard_price')
    tds_avg_cost = fields.Float('Total Cost', compute='_calc_avg_cost')
...
class TDSBom(models.Model):
    _inherit = 'mrp.bom'
    total_tds_cost = fields.Float(compute='_calc_total_tds_cost')
    tds_avg_cost = fields.Float(compute='_calc_tds_avg_cost')
